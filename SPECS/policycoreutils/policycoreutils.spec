...
%make_install -C restorecond PYTHON=python3 SBINDIR="%{_sbindir}" LIBDIR="%{_libdir}" LIBSEPOLA="%{_libdir}/libsepol.a" SYSTEMDDIR="/lib/systemd" CFLAGS="%{build_cflags} -fno-semantic-interposition"
